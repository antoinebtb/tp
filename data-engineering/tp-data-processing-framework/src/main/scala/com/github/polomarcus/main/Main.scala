...
object Main {
  def main(args: Array[String]) {
    ...
    val outputPath = "C:\\Users\\betbe\\Desktop\\Montpellier cours\\Data processing developpement\\TP\\tp\\data-engineering\\tp-data-processing-framework\\src\\main\\scala\\com\\github\\polomarcus\\utils"
    result.write
